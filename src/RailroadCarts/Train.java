    ...
    public void run() {
        ...
        while(true) {
            while (currentStation < route.size() - 1) {
                try {
                    //System.out.println("Train with id: " + id + " , entered station: " + route.get(currentStation).getId());
                    Thread.sleep(2000);
                    ...
                    if (route.get(currentStation).isAvailable()) {
                        ...
                        //System.out.println("Train with id: " + id + ", waiting at: " + route.get(currentStation).getId());
                        Thread.sleep(2000);
                        route.get(currentStation).setAvailable(false);
                    }
